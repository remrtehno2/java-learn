...
public class Test {
    ...
    private static NavigableMap<LocalDate,List<Purchase>> datedPurchases = new TreeMap<>();
    ...
    private static void printStudentsAndPurchases() {
        System.out.println("\n************************ Print [Purchases, Students] as it is ************************\n");
    ...
    private static void printByWeeks() {
        System.out.println("\n************************ Print [Purchases] by Weeks ************************\n");
...
//        week2Purchases.forEach((key, value) -> System.out.println(key + ": " + value));
    ...
    private static void printByDatesTotalPurchases() {
        System.out.println("\n************************ Print [Total Purchases] by Dates  ************************\n");
...
//       //     nextEntry = reversed.higherEntry(firstDate);
    ...
    public static void main(String[] args) {
        ...
        printStudentsAndPurchases();

        printByDates();

        printByWeeks();

        printByDatesTotalPurchases();
    }
