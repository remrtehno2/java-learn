...
public class Student {
    ...
    public static Student getRandomStudent(Course... courses) {
        ...
        int maxYear = LocalDate.now().minusYears(4).getYear() + 1;


        int randomCoursesCount = random.nextInt(1, courses.length + 1);
        Course[] courses1 = new Course[randomCoursesCount];

        Arrays.setAll(courses1, c -> courses[c]);
